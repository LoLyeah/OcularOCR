...
export const translationDict: Translations = {
  ...
  localNoPassword: { en: 'LOCAL · NO PASSWORD', id: 'LOKAL · TANPA KATA SANDI' },
  ...
  chooseVaultMode: { en: 'Choose how this local vault should open. You can reset the vault later to choose again.', id: 'Pilih cara membuka vault lokal ini. Anda dapat mereset vault nanti untuk memilih kembali.' },
  encryptedVaultRecommended: { en: 'Encrypted Vault (Recommended)', id: 'Vault Terenkripsi (Direkomendasikan)' },
  encryptedVaultHelp: { en: 'Protect documents and AI settings with a password required on each new session.', id: 'Lindungi dokumen dan pengaturan AI dengan kata sandi yang diperlukan pada setiap sesi baru.' },
  unencryptedVault: { en: 'Unencrypted / No Password', id: 'Tanpa Enkripsi / Tanpa Kata Sandi' },
  unencryptedVaultWarning: { en: 'Automatically unlocks. Anyone with access to this browser profile can read the vault; do not use it for sensitive documents or API keys.', id: 'Terbuka otomatis. Siapa pun yang dapat mengakses profil peramban ini dapat membaca vault; jangan gunakan untuk dokumen sensitif atau API key.' },
  failedSetupUnencrypted: { en: 'Failed to create the unencrypted vault.', id: 'Gagal membuat vault tanpa enkripsi.' },
  backToVaultOptions: { en: 'Back to vault options', id: 'Kembali ke pilihan vault' },
  ...
  storageHealthTitle: { en: 'Device storage health', id: 'Kesehatan penyimpanan perangkat' },
  storageHealthHelp: { en: 'Monitor browser storage capacity and reduce the risk of automatic data eviction.', id: 'Pantau kapasitas penyimpanan peramban dan kurangi risiko penghapusan data otomatis.' },
  storageUsed: { en: 'Storage used', id: 'Penyimpanan terpakai' },
  storageHealthy: { en: 'Storage capacity is healthy', id: 'Kapasitas penyimpanan sehat' },
  storageWarning: { en: 'Storage is running low—export a backup soon', id: 'Penyimpanan mulai menipis—segera ekspor cadangan' },
  storageCritical: { en: 'Storage is almost full—export a backup now', id: 'Penyimpanan hampir penuh—ekspor cadangan sekarang' },
  storageUnknown: { en: 'Storage capacity could not be measured', id: 'Kapasitas penyimpanan tidak dapat diukur' },
  storagePersistent: { en: 'Protected from automatic browser cleanup', id: 'Terlindungi dari pembersihan otomatis peramban' },
  storageTemporary: { en: 'The browser may remove data when device storage is low', id: 'Peramban dapat menghapus data saat penyimpanan perangkat menipis' },
  storagePersistenceUnknown: { en: 'This browser does not report automatic-cleanup protection', id: 'Peramban ini tidak melaporkan perlindungan dari pembersihan otomatis' },
  storageUnavailable: { en: 'Storage diagnostics are not supported by this browser.', id: 'Diagnostik penyimpanan tidak didukung oleh peramban ini.' },
  storageMeasuring: { en: 'Measuring browser storage…', id: 'Mengukur penyimpanan peramban…' },
  protectStorageBtn: { en: 'Request protection', id: 'Minta perlindungan' },
  requestingStorageProtection: { en: 'Requesting…', id: 'Meminta…' },
  storageProtectionGranted: { en: 'Storage protection enabled', id: 'Perlindungan penyimpanan diaktifkan' },
  storageProtectionDenied: { en: 'The browser did not grant storage protection', id: 'Peramban tidak memberikan perlindungan penyimpanan' },
  vaultInitFailedHelp: { en: 'OcularOCR could not connect to encrypted browser storage. Your existing vault has not been erased.', id: 'OcularOCR tidak dapat terhubung ke penyimpanan terenkripsi peramban. Vault Anda tidak dihapus.' },
  retryBtn: { en: 'Try again', id: 'Coba lagi' },
  technicalDetails: { en: 'Technical details', id: 'Detail teknis' },
  ...
  offlineReadyTitle: { en: 'Ready for offline OCR', id: 'Siap untuk OCR offline' },
  offlineReadyHelp: { en: 'The app shell, PDF renderer, OCR engine, and bundled languages are cached on this device.', id: 'App shell, perender PDF, mesin OCR, dan bahasa bawaan tersimpan di perangkat ini.' },
  offlineNotReadyTitle: { en: 'Offline setup incomplete', id: 'Persiapan offline belum lengkap' },
  offlineNotReadyHelp: { en: '{{count}} required assets still need to be cached.', id: '{{count}} aset wajib masih perlu disimpan.' },
  networkOnline: { en: 'Network available', id: 'Jaringan tersedia' },
  networkOffline: { en: 'Currently offline', id: 'Saat ini offline' },
  prepareOfflineBtn: { en: 'Prepare', id: 'Siapkan' },
  preparingOffline: { en: 'Preparing…', id: 'Menyiapkan…' },
  offlinePrepareFailed: { en: 'Offline setup failed', id: 'Persiapan offline gagal' },
  languagePackReady: { en: 'Language pack ready offline', id: 'Paket bahasa siap offline' },
  languagePackFailed: { en: 'Language pack download failed', id: 'Unduhan paket bahasa gagal' },
  downloadLanguagePack: { en: 'Download for offline use', id: 'Unduh untuk penggunaan offline' },
  removeLanguagePack: { en: 'Remove offline download', id: 'Hapus unduhan offline' },
  languagePackLegend: { en: 'Green means available offline. Additional languages can be downloaded or removed here.', id: 'Hijau berarti tersedia offline. Bahasa tambahan dapat diunduh atau dihapus di sini.' },
  exportSearchablePdf: { en: 'Searchable PDF (Sandwich)', id: 'PDF Dapat Dicari (Sandwich)' },
  exportReflowedPdf: { en: 'Reflowed PDF', id: 'PDF Reflow' },
  pdfWorkspaceBtn: { en: 'PDF Workspace', id: 'Ruang Kerja PDF' },
  pdfWorkspaceTitle: { en: 'PDF Workspace', id: 'Ruang Kerja PDF' },
  pdfWorkspaceLoading: { en: 'Preparing PDF workspace…', id: 'Menyiapkan ruang kerja PDF…' },
  pdfWorkspaceDecrypting: { en: 'Decrypting {{name}}…', id: 'Mendekripsi {{name}}…' },
  pdfWorkspaceRendering: { en: 'Creating thumbnails for {{name}}…', id: 'Membuat thumbnail untuk {{name}}…' },
  pdfWorkspaceBuilding: { en: 'Building the new PDF locally…', id: 'Membuat PDF baru secara lokal…' },
  pdfWorkspaceTooLarge: { en: 'The selected PDFs exceed the 100 MB workspace limit.', id: 'PDF yang dipilih melebihi batas ruang kerja 100 MB.' },
  pdfWorkspaceOutputTooLarge: { en: 'The new PDF exceeds the 100 MB output limit.', id: 'PDF baru melebihi batas keluaran 100 MB.' },
  pdfWorkspaceTooManyPages: { en: 'A workspace can contain at most {{count}} pages.', id: 'Ruang kerja dapat memuat maksimal {{count}} halaman.' },
  pdfWorkspaceSourceSummary: { en: '{{files}} source file(s) · {{pages}} page(s)', id: '{{files}} file sumber · {{pages}} halaman' },
  pdfWorkspaceKeepOnePage: { en: 'Keep at least one page in the PDF', id: 'Simpan setidaknya satu halaman di PDF' },
  pdfWorkspaceOriginalSafe: { en: 'The original encrypted PDFs will not be changed.', id: 'PDF terenkripsi asli tidak akan diubah.' },
  pdfWorkspaceSaved: { en: 'New encrypted PDF saved', id: 'PDF terenkripsi baru disimpan' },
  pdfPageThumbnail: { en: 'Thumbnail for source page {{page}}', id: 'Thumbnail halaman sumber {{page}}' },
  pdfOutputName: { en: 'New PDF name', id: 'Nama PDF baru' },
  sourcePage: { en: 'Source page {{page}}', id: 'Halaman sumber {{page}}' },
  undo: { en: 'Undo', id: 'Urungkan' },
  rotateLeft: { en: 'Rotate left', id: 'Putar kiri' },
  rotateRight: { en: 'Rotate right', id: 'Putar kanan' },
  duplicate: { en: 'Duplicate', id: 'Duplikat' },
  deletePages: { en: 'Delete pages', id: 'Hapus halaman' },
  clearSelection: { en: 'Clear selection', id: 'Hapus pilihan' },
  selectAllPages: { en: 'Select all pages', id: 'Pilih semua halaman' },
  extractSelectedPages: { en: 'Extract selected ({{count}})', id: 'Ekstrak pilihan ({{count}})' },
  saveAsNewPdf: { en: 'Save as new PDF', id: 'Simpan sebagai PDF baru' },
  moveEarlier: { en: 'Move earlier', id: 'Pindah ke depan' },
  moveLater: { en: 'Move later', id: 'Pindah ke belakang' },
  skipToContent: { en: 'Skip to main content', id: 'Lewati ke konten utama' },
  structuredOcrLabel: { en: 'Structured OCR (Experimental)', id: 'OCR Terstruktur (Eksperimental)' },
  structuredOcrSub: { en: 'Extract blocks with bounding boxes from vision AI (requires model support)', id: 'Ekstrak blok dengan kotak batas dari AI vision (memerlukan dukungan model)' },
  structuredOcrWarn: { en: 'Structured output not supported by this model, falling back to text-only OCR', id: 'Output terstruktur tidak didukung oleh model ini, beralih ke OCR teks saja' },
  configureOcr: { en: 'Configure OCR', id: 'Konfigurasi OCR' },
  ocrModeAuto: { en: 'Auto', id: 'Otomatis' },
  ocrModeManual: { en: 'Manual', id: 'Manual' },
  ocrModeOff: { en: 'Off', id: 'Mati' },
  previewBefore: { en: 'Before', id: 'Sebelum' },
  previewSplit: { en: 'Split', id: 'Terpisah' },
  previewAfter: { en: 'After', id: 'Sesudah' },
  runOcrNow: { en: 'Run OCR', id: 'Jalankan OCR' },
  ...
  noPasswordStorageBadge: { en: 'Local storage · No password protection', id: 'Penyimpanan lokal · Tanpa perlindungan kata sandi' },
