...
export function ToastProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ToastContext.Provider value={{ toast }}>
      {children}
      <div style={{ bottom: 'calc(1rem + env(safe-area-inset-bottom))' }} className="fixed right-4 z-50 flex flex-col gap-2 w-full max-w-sm pointer-events-none px-4 sm:px-0">
